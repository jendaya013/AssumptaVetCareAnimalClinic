...
<div class="container-fluid">
    <form action="" id="appointment-form">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Animal Information</legend>
                    <div class="form-group">
                        <label for="category_id" class="control-label">Animal Type</label>
                    ...
                    <div class="form-group">
                        <label for="breed" class="control-label">Animal Name</label>
                        <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="age" class="control-label">Clinic Branch</label>
                        <input type="text" name="location" id="location" class="form-control form-control-border" placeholder="Tigaon/Goa" value ="<?php echo isset($location) ? $location : '' ?>" required>
                    </div>
                </fieldset>
                <div class="form-group">
