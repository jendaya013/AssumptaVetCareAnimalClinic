        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="list-group">
                    ...
                    <?php 
                    $category_qry = $conn->query("SELECT * FROM `category_list` where delete_flag = 0");
            ...
            <?php 
                ...
                $products = $conn->query("SELECT * FROM `product_list` where delete_flag = 0 {$cwhere}  order by `name` asc");
                ...
                <div class="text-decoration-none list-group-item rounded-0 service-item">
                    ...
                    <div class="collapse" id="service_<?= $row['id'] ?>">
                        ...
                        <div class="row align-items-top">
                            <div class="col-10">
                                <img width="230" class="" height="220"  src="<?php echo validate_image(isset($row['image']) ? $row['image'] :'') ?>" alt="">
                            </div>
...
<script>
    function _category_filter(){
        if($('#category_all').is(":checked") == true){
            ...
            location.href="./?page=products&cids="+cids
        }
    }
    $(function(){
